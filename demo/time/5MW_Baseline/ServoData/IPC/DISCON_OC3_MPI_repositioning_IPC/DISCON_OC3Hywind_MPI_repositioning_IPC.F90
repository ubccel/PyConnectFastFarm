...
!=======================================================================
   ...
   ! Send turbine measurements to supercontroller
   to_SC(1)  = avrSWAP(27)                    ! hub wind speed, m/s
   to_SC(2)  = avrSWAP(15)                    ! measured electrical power, W
   to_SC(3)  = avrSWAP(24) + avrSWAP(37)      ! wind direction from North (yaw error + nacelle yaw angle), rad
   to_SC(4)  = YawAngle                        ! measured nacelle yaw angle, rad
   to_SC(5)  = avrSWAP(4)                     ! measured blade 1 pitch angle, rad
   to_SC(6)  = avrSWAP(23)                    ! measured generator torque, N-m
   to_SC(7)  = avrSWAP(30)                    ! blade 1 root out-of-plane bending moment, N-m
   to_SC(8)  = avrSWAP(31)                    ! blade 2 root out-of-plane bending moment, N-m
   to_SC(9)  = avrSWAP(32)                    ! blade 3 root out-of-plane bending moment, N-m
   to_SC(10) = avrSWAP(69)                    ! blade 1 root in-plane bending moment, N-m
   to_SC(11) = avrSWAP(70)                    ! blade 2 root in-plane bending moment, N-m
   to_SC(12) = avrSWAP(71)                    ! blade 3 root in-plane bending moment, N-m
   to_SC(13) = avrSWAP(1001)                   ! platform displacement TDX (x), m
   to_SC(14) = avrSWAP(1002)                   ! platform displacement TDY (y), m
   to_SC(15) = avrSWAP(33)                     ! blade 2 pitch angle, rad
   to_SC(16) = avrSWAP(34)                     ! blade 3 pitch angle, rad
