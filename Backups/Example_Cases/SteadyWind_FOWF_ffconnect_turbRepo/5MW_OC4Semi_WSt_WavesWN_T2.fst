...
"NRELOffshrBsline5MW_OC4DeepCwindSemi_ServoDyn_T2.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
...
"NRELOffshrBsline5MW_OC4DeepCwindSemi_MoorDyn_turbRepo.dat"    MooringFile     - Name of file containing mooring system input parameters (quoted string)
